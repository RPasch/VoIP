        ...
        while (true) {
            try {
                ...
                if (toUser.equals("All")) {
                    ...
                    Server.confCallUsers.remove(connectingUsername);
                    ...
                    if (message.equals("+")) {
                        Server.gui.updateActivity(username + " is chatting to " + toUser);
                    }
                    if (message.equals("-")) {
                        Server.gui.updateActivity(toUser + " declined a call from " + username);
                    }
